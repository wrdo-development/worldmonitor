...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  wrdo: {
    title: 'WRDO Cave - Tech & AI Intelligence Dashboard',
    description: 'WRDO Cave — real-time tech, AI, cybersecurity, and developer intelligence dashboard built for the WRDO platform. South African tech meets global dev tooling.',
    keywords: 'WRDO, cave dashboard, AI news, tech intelligence, cybersecurity, developer community, GitHub trending, service status, South Africa tech, MyBroadband, ITWeb, Daily Maverick',
    url: 'https://cave.wrdo.co.za/',
    siteName: 'WRDO Cave',
    shortName: 'WRDO Cave',
    subject: 'Tech, AI, and Developer Intelligence',
    classification: 'Tech Dashboard, AI Tracker, Developer Intelligence',
    categories: ['news', 'productivity'],
    features: [
      'Tech & AI news aggregation',
      'Cybersecurity feed',
